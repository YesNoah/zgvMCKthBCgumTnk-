...
import shutil
import random
os.chdir(os.path.join(os.getcwd(), "scales"))
os.getcwd()
...
human_files = [f for f in os.listdir(human_dir) if f.endswith(".jpg") or f.endswith(".png")]
ai_files = [f for f in os.listdir(ai_dir) if f.endswith(".jpg") or f.endswith(".png")]
